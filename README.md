...
Citi Bike trips are short, less than one hour. Subscribers are the main business model. When looking at subscriber rate and duration of use, men tend to use the program more. Utlizing a bike repair plan is essential for the bikes used in the most popular areas. More visualizations can be performed with the data set, analyzation of times of bike usage and age range. It would also help to look at how far bikers travel and which stations are the most popular. A closer look at station locations might provide clarity on why more women aren't using the bike-share program.
